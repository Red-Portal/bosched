...
parse_schedule (void)
{
  ...
  if (strncasecmp (env, "static", 6) == 0)
    ...
    {
      gomp_global_icv.run_sched_var = GFS_FAC2;
      env += 4;
    }
  else if (strncasecmp (env, "rand", 4) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_RAND;
      env += 4;
    }
  else if (strncasecmp (env, "awf", 3) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_AWF;
      env += 3;
    }
  else if (strncasecmp (env, "fact", 4) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_FACT;
      env += 4;
    }
  else if (strncasecmp (env, "tape", 4) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_TAPE;
      env += 4;
    }
  else if (strncasecmp (env, "frac", 4) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_FRAC;
      env += 4;
    }
  else if (strncasecmp (env, "wfac", 4) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_WFAC;
      env += 4;
    }
  else if (strncasecmp (env, "bold", 4) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_BOLD;
      env += 4;
    }
  else if (strncasecmp (env, "trap", 4) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_TRAP;
      env += 4;
    }
  else if (strncasecmp (env, "fsc", 3) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_FSC;
      env += 3;
    }
  else if (strncasecmp (env, "afac", 4) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_AFAC;
      env += 4;
    }
  ...
  else if (strncasecmp (env, "fac", 3) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_FACT;
      env += 3;
    }
  ...
  else if (strncasecmp (env, "wf", 2) == 0)
    {
      gomp_global_icv.run_sched_var = GFS_WFAC;
      env += 2;
    }
