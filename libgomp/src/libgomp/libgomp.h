...
extern bool gomp_iter_fact_next (long *, long *);
extern bool gomp_iter_trap_next (long *, long *);
extern bool gomp_iter_tape_next (long *, long *);
extern bool gomp_iter_frac_next (long *, long *);
extern bool gomp_iter_wfac_next (long *, long *);
extern bool gomp_iter_bold_next (long *, long *);
extern bool gomp_iter_fsc_next (long *, long *);
extern bool gomp_iter_afac_next (long *, long *);
extern bool gomp_iter_rand_next (long *, long *);
extern bool gomp_iter_fac2_next (long *, long *);


#endif

/* loop.c */
//EXPORT extern double omp_set_chunksize_fsc(double sigma, double h, int n, int p);
